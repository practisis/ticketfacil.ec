...
class InitTicket{
	...
	public $pages = array(
		...
		'ventasPorDistribuidor' => array('path' => 'spadmin/impresionesSelfDist.php'),
		'resumenPuntosVenta' => array('path' => 'spadmin/resumenPuntosVenta.php'),
		'ingresa_boletos_distribuidor_tf' => array ('path' => 'subpages/ingresa_boletos_distribuidor_tf.php', 'title' => ''),
		...
		'membresias' => array ('path' => 'spadmin/membresias.php', 'title' => ''),
		'membresia_socio' => array ('path' => 'spadmin/membresia_socio.php', 'title' => ''),
		'pagar_membresias' => array ('path' => 'spadmin/pagar_membresias.php', 'title' => ''),
		...
		'pagos_web_' => array ('path' => 'spadmin/pagos_web_.php', 'title' => ''),
		...
		'reimpresionLote' => array('path' => 'SP/reimpresionLote.php', 'title' => ''),
		'nuevo_admin' => array('path' => 'adminNuevo/index.php', 'title' => 'Nuevo Admin'),
		'add_tipo_socio' => array('path' => 'TipoSocio/add_tipo_socio.php', 'title' => ''),
		...
		'impresionFacturas' => array('path' => 'subpages/Facturas/facturacion2.php', 'title' => 'Impresion Facturas'),
		'equipos' => array('path' => 'Equipos/crear_equipo.php', 'title' => 'Crear Equipos'),
		'impresionesDistribuidorEmpresario' => array('path' => 'spadmin/impresionesDistribuidorEmpresario.php', 'title' => ''),
		'valores' => array('path' => 'Valores/crear_valor.php', 'title' => 'Crear Valor'));
	...
	$slidertriple = "SELECT idConcierto, strImagen , es_publi , strEvento FROM Concierto WHERE costoenvioC = 1 and strCaractristica = 'home' ORDER BY dateFecha DESC";
