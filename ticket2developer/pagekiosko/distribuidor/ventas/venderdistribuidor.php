					...
					<div class="row">
						<div class="col-lg-5">
							...
							<div class="input-group">
								<input type="text" class="inputlogin form-control" placeholder="Documento de Identidad del Cliente" id="buscarcliente" aria-describedby="basic-addon2" autocomplete="off" onchange="ValidarDocumento(this,this.value)" maxlength="13" />
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="alert alert-info" role="alert">
								<span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
									&nbsp;<strong>Aviso!</strong>&nbsp;No puede haber dos Cédulas iguales con distintos nombres.
							</div>
						</div>
						<div class="modal-footer">
