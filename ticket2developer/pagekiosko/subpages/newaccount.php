...
<div style="margin:10px -10px;">
	<div style="background-color:#171A1B; padding:20px;">
				...
				<div style="background-color:#00ADEF; margin-left:40px; margin-right:-42px; position:relative;">
					<table class="table-response" style="width:100%; color:#000; font-size:20px; border-collapse: separate; border-spacing: 20px 15px;">
						...
						<tr>
							<td colspan="3">
								<center>
									<a class="btn_login" id="aceptar" name="aceptar" onclick="enviar()" style="text-decoration:none; display:none; cursor:pointer;">
		...
		<div class="modal fade" id="bienvenida" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" onclick="window.location.href = '?modulo=start';">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-primary" onclick="window.location.href = '?modulo=start';">Aceptar</button>
					</div>
				</div>
			</div>
		</div>
