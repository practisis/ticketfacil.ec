				...
				<div class="row">
					...
					<div class="col-lg-5">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control inputlogin" aria-describedby="basic-addon1" readonly="readonly" style="color:#000;" value="<?php echo $row['strDocumentoC'];?>" />
						</div>
					</div>
				</div>
				<div class="row">
...
function guardar(){
	...
	if((nombre == '') || (movil == '')){
		...
		$.post('subpages/guardarperfil.php',{
			id : id, nombre : nombre, genero : genero, fechanac : fechanac, movil : movil, forma : forma, envio : envio, dir : dir, fijo : fijo, provincia : provincia, ciudad : ciudad
