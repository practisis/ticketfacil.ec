					...
					<table style="width:100%; color:#fff;">
						<tr>
							...
							<td style="color:#FFF100; text-align:right;">
								<a href="?modulo=des_concierto&con=<?php echo $con;?>">Cancelar Compra</a>
							</td>
						</tr>
					</table>
				</div>
					...
					<table style="width:100%; color:#fff; font-size:20px;">
						...
						<tr>
							...
							<td style="text-align:right; font-size:25px; padding-right:40px;">
								<strong><?php echo $totalpagar;?><input type="hidden" id="total_pagar" name="total_pagar" value="<?php echo $totalpagar;?>" class="added resumen" readonly="readonly" size="7"/></strong>
					...
					<div class="modal-body">
						...
						<h4 id="alerta7" class="alertas" style="display:none;">
							<div class="alert alert-info" role="alert"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
								...
								<?php echo $rowc['tiempopagoC'];?> para registrar tu Deposito.<br/><br/>
						...
						<h4 id="alerta8" class="alertas" style="display:none;">
							<div class="alert alert-info" role="alert"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
								Tu pago lo puedes efectuar en:<br/>
								<blockquote>
									<?php
										echo $rowc['locPago']."<br/>";
										echo $rowc['dirPago']."<br/>";
										echo $rowc['fecha']."<br/>";
										echo "En el horario de : ".$rowc['hora']."<br/>";
									?>
		...
		if($('#check').is(':checked')){
			...
			if(pago == 0){
				...
				if(pago == 1){
					...
					// $('#alerta8').fadeIn();
					// $('#aviso').modal('show');
					accion = 'subpages/Compras/puntodeventa.php?evento='+evento;
					$('#datos').attr('action', accion);
					$('#datos').submit();
				}
			}
