...
?>
	...
	<center>
		...
		<table class = 'table' id='testTable1'>
			<tr>
				<td colspan = "9" >
					REPORTE INGRESOS CLAN JUVENIL vs BARCELONA SPORTING CLUB (2017/03/04)
				<td/>
			<tr/>
			<tr>
				<th>Localidad</th>
	...
	<?php
			...
			$sql = 'select count(idBoleto) as vendidos from Boleto where idCon = "'.$_REQUEST['id_concierto'].'" and idLocB = "'.$rowCo1['idLocalidad'].'" and tercera = "0" and strEstado = "I"';
	...
	<?php
			...
			$sqlBoTer = 'select count(idBoleto) as vendidos from Boleto where idCon = "'.$_REQUEST['id_concierto'].'" and idLocB = "'.$rowLoTer['idLocalidad'].'" and tercera = "1" and strEstado = "I"';
	...
	<?php
			...
			$sqlBoNi = 'select count(idBoleto) as vendidos from Boleto where idCon = "'.$_REQUEST['id_concierto'].'" and idLocB = "'.$rowLoNi['idLocalidad'].'" and tercera = "2" and strEstado = "I"';
