...
<?php
	...
	if($pventa != ''){
		$sqlU = 'SELECT * FROM `Usuario` WHERE `strObsCreacion` = "'.$pventa.'" ORDER BY `strObsCreacion` DESC';
		...
		echo '<input type = "hidden" id = "pventa" value = "'.$idDist.'" />';
	}else{
		echo '<input type = "hidden" id = "pventa" value = "100000" />';
		$filtroDist = '';
	}
...
<script src="https://code.jquery.com/jquery-1.12.4.js"></script>
	...
	<style>
		...
		.botonimagen{
			background-image:url(Estadisticas/ajax/excel.jpg);
	...
	<script>
		function verDescuentos(ident , idCon , tipo_reporte){
			...
			if(ident == 9){
				ruta = 'desglose_descuentos_general.php';
			}
			
			$.post("Estadisticas/ajax/descuentos/"+ruta+"",{ 
				idCon : idCon , tipo_reporte : tipo_reporte , pventa : pventa
			}).done(function(data){
		...
		function verDescuentos_2(id){
			$('#loaderGif_5').css('display','block');
			var pventas = $('#pventas').val();
			$.post("spadmin/verReporteBorderoMunicipio.php",{ 
				id : id , pventas : pventas
			}).done(function(data){
				$('#loaderGif_5').css('display','none');
				$('#contenedorDescuentos').fadeIn('slow');
				$('#cuerpoDescuentos').html(data);
		...
		function verDescuentos_4(id){
			$('#loaderGif_7').css('display','block');
			var pventas = $('#pventas').val();
			$.post("spadmin/verReporteBorderoMunicipioVentas.php",{ 
				id : id , pventas : pventas
			}).done(function(data){
				$('#loaderGif_7').css('display','none');
				$('#contenedorDescuentos').fadeIn('slow');
				$('#cuerpoDescuentos').html(data);
			});
		}
		...
		function verDescuentos_3(id){
			var pventas = $('#pventas').val();
			$('#loaderGif_9').css('display','block');
			$.post("spadmin/verReporteBorderoVentas.php",{ 
				id : id , pventas : pventas
			}).done(function(data){
				$('#loaderGif_9').css('display','none');
				$('#contenedorDescuentos').fadeIn('slow');
		...
		function verDescuentos_1(id){
			var pventas = $('#pventas').val();
			$('#loaderGif_6').css('display','block');
			$.post("spadmin/verReporteBordero.php",{ 
				id : id , pventas : pventas
			}).done(function(data){
				$('#loaderGif_6').css('display','none');
				$('#contenedorDescuentos').fadeIn('slow');
				$('#cuerpoDescuentos').css('background-color','#fff');
				$('#cuerpoDescuentos').html(data);
		...
		function verDescuentos_5(id_con){
			// var pventas = $('#pventas').val();
			// $('#loaderGif_11').css('display','block');
			// $.post("http://www.ticketfacil.ec/ticket2/seguridad/reporte.php?id_con=282",{ 
				// id_con : id_con
			// }).done(function(data){
				// $('#loaderGif_11').css('display','none');
				// $('#contenedorDescuentos').show('explode' , 500);
				// $('#cuerpoDescuentos').css('background-color','#fff');
				// $('#cuerpoDescuentos').html(data);
				
			// });
			
			window.open('http://www.ticketfacil.ec/ticket2/seguridad/reporte.php?id_con='+id_con,'_blank');
		}
	</script>
	<center>
	...
	<button type="button" class="btn btn-default" onclick = 'verDescuentos(1 , <?php echo $idConcierto;?> ,3)'>DESGLOSE DE DESCUENTOS <center><img src = 'imagenes/load22.gif' id = 'loaderGif_1' style = 'display:none;width:30px;'/></center></button>
	<button type="button" class="btn btn-default" onclick = 'verDescuentos(9 , <?php echo $idConcierto;?> ,3)'>DESGLOSE DE DESCUENTOS GENERAL <center><img src = 'imagenes/load22.gif' id = 'loaderGif_1' style = 'display:none;width:30px;'/></center></button>
	
	<button type="button" class="btn btn-default" onclick = 'verDescuentos(4 , <?php echo $idConcierto;?> ,3 )'>TICKETS LOCALIDAD VS DESCUENTOS <center><img src = 'imagenes/load22.gif' id = 'loaderGif_4' style = 'display:none;width:30px;'/> </center></button>
	
	<button type="button" class="btn btn-default" onclick = 'verDescuentos_1(<?php echo $idConcierto;?>)'>REPORTE VALOR IMPRESO <center><img src = 'imagenes/load22.gif' id = 'loaderGif_6' style = 'display:none;width:30px;'/> </center></button>
	<button type="button" class="btn btn-default" onclick = 'verDescuentos_2(<?php echo $idConcierto;?>)'>REPORTE VALOR IMPRESO MACRO <center><img src = 'imagenes/load22.gif' id = 'loaderGif_5' style = 'display:none;width:30px;'/> </center></button>
	
	
	<button type="button" class="btn btn-default" onclick = 'verDescuentos_3(<?php echo $idConcierto;?>)'>REPORTE VALOR VENDIDO <center><img src = 'imagenes/load22.gif' id = 'loaderGif_9' style = 'display:none;width:30px;'/> </center></button>
	
	<button type="button" class="btn btn-default" onclick = 'verDescuentos_4(<?php echo $idConcierto;?>)'>REPORTE VALOR VENDIDO MACRO <center><img src = 'imagenes/load22.gif' id = 'loaderGif_7' style = 'display:none;width:30px;'/> </center></button>
	
	
	<button type="button" class="btn btn-default" onclick = 'verDescuentos_5(<?php echo $idConcierto;?>)'>REPORTE INGRESOS <center><img src = 'imagenes/load22.gif' id = 'loaderGif_11' style = 'display:none;width:30px;'/> </center></button>
	<!--
	<button type="button" class="btn btn-default" onclick = 'verDescuentos(5 , <?php echo $idConcierto;?>) , 2'>VENTAS WEB <center><img src = 'imagenes/load22.gif' id = 'loaderGif_5' style = 'display:none;width:30px;'/> </center></button>
	<button type="button" class="btn btn-default" onclick = 'verDescuentos(6 , <?php echo $idConcierto;?>) , 2'>VENTAS CADENA COMERCIAL <center><img src = 'imagenes/load22.gif' id = 'loaderGif_6' style = 'display:none;width:30px;'/> </center></button>
	<button type="button" class="btn btn-default" onclick = 'verDescuentos(7 , <?php echo $idConcierto;?>) , 2'>VENTAS CADENA TICKETFACIL<center><img src = 'imagenes/load22.gif' id = 'loaderGif_7' style = 'display:none;width:30px;'/> </center></button>
	-->

	<table  style='font-size:12px;position:relative;background-color:#fff;' width ='100%' border ='1' id = 'contieneConciertosSocio'>
		<tr>
...
?>
	<tr class = 'tr_cadalocalidad'>
			...
			<td style = 'text-align:right;border:1px solid #fff;padding-rigth:10px;'>
