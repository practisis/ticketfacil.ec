...
<script src="https://code.jquery.com/jquery-1.12.4.js"></script>
	...
	<div id = 'taquilla_venta_socio'></div>
	<!--<iframe id = 'iframe1' src = 'http://ticketfacil.ec/ticket2/Estadisticas/ajax/taquilla_venta_socio.php?id_concierto=<?php echo $idConcierto?>' class ='ifr1' style = 'position:relative;left: 0px;width:960px;height: 590px;background-color: #00ADEF' frameborder = '0' ></iframe>-->
...
?>
	...
	<div id = 'contieneIframes' style = 'display:none;' >
		...
		<iframe id = 'iframe2' src = 'http://ticketfacil.ec/ticket2/Estadisticas/ajax/cadenaTFSocio.php?idConcierto=<?php echo $idConcierto?>' class ='ifr2' style = 'position:relative;left: -25px;width:985px;height: 850px' frameborder = '0'></iframe>
	</div>
	<br/><br/>
	<table class = 'table' >
		<tr>
	...
	<table class = 'table' style = 'display:none;'>
		...
		<?php
			$sqlLo = 'select * from Localidad where idConc = "'.$idConcierto.'" order by idLocalidad DESC';
	...
	<table class = 'table' >
		...
		<tr>
			...
			<td>
				<?php echo ($sumaCortesias + ($sumaGlobalTickets + $num_bol1));?>
			</td>
			<td>
				
			</td>
			<td>
				<?php echo ((($sumaGlobalTickets + $num_bol1) * $valorados) + ($sumaCortesias * $cortesias));?>
			</td>
		</tr>
	</table>
	...
	<table class = 'table' >
		...
		<tr>
			...
			<td>
				<?php 
					$costoServicio =  ((($sumaGlobalTickets + $num_bol1) * $valorados) + ($sumaCortesias * $cortesias));
					echo $costoServicio;
				?>
			</td>
		</tr>
		<tr>
			...
			<td>
				<?php 
					$ivaServicio =  (((($sumaGlobalTickets + $num_bol1) * $valorados) + ($sumaCortesias * $cortesias)) * 0.14);
	...
	<br/><br/>
	<iframe  id = 'iframeMuni' src = 'http://ticketfacil.ec/ticket2/Estadisticas/ajax/minicipio.php?idConcierto=<?php echo $idConcierto?>' style="position: relative; left: -10px;width:955px;height:400px;background-color:#00ADEF;" frameborder="0" ></iframe>
	...
	<table class = 'table' >
		...
		<tr>
			...
			<td>
				<?php 
					echo number_format(($costoMenosIva),2);
					echo "<input type = 'hidden' id = 'valorFacturaResumen'  value = '".number_format(($costoMenosIva),2)."' />";
				?>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<div id = 'totalImpuestoMunicipio_pagar'></div>
			</td>
		</tr>
	...
	<script>
		...
		setTimeout(function(){
			...
			//alert(totalImpuestoMunicipio_pagar +'cccc');
			$('#totalImpuestoMunicipio_pagar').html(totalImpuestoMunicipio);
			...
			//+ parseFloat(efec_cad_com) + parseFloat(efec_cad_com_pre) --> aqui abajo x si acaso se dañe esta mierda
			var sumaEfectivos = (parseFloat(efec_web) + parseFloat(efec_web_prev) + parseFloat(efec_cad_tic) + parseFloat(efec_cad_tic_prev) ).toFixed(2);
			// if(isNaN(sumaEfectivos)){
				// alert(isNaN(sumaEfectivos));
				// var sumaEfectivos = 0;
			// }else{
				// alert(sumaEfectivos);
			// }
			...
			// if(isNaN(sumaTarjetasWeb)){
				// var sumaTarjetasWeb = 0;
			// }else{
			// }
			...
			// if(isNaN(sumaTarjetasCadCom)){
				// var sumaTarjetasCadCom = 0;
			// }else{
			// }
			...
			// if(isNaN(sumaTarjetasCadTick)){
				// var sumaTarjetasCadTick = 0;
			// }else{
			// }
			...
			// alert(sumaGlobalCogrado_reporte);
			...
			$.post("Estadisticas/ajax/taquilla_venta_socio.php",{ 
				id_concierto : id_concierto 
			}).done(function(data){
				$('#taquilla_venta_socio').html(data);
