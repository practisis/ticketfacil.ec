...
<script src="https://code.jquery.com/jquery-1.12.4.js"></script>
	...
	<button type="button" class="btn btn-default" onclick = 'verDescuentos(1 , <?php echo $idConcierto;?> ,2)'>DESGLOSE DE DESCUENTOS <center><img src = 'imagenes/load22.gif' id = 'loaderGif_1' style = 'display:none;width:30px;'/></center></button>
	<button type="button" class="btn btn-default" onclick = 'verDescuentos(9 , <?php echo $idConcierto;?> ,2)'>DESGLOSE DE DESCUENTOS GENERAL <center><img src = 'imagenes/load22.gif' id = 'loaderGif_1' style = 'display:none;width:30px;'/></center></button>
	
	<button type="button" class="btn btn-default" onclick = 'verDescuentos(4 , <?php echo $idConcierto;?> ,2 )'>TICKETS LOCALIDAD VS DESCUENTOS <center><img src = 'imagenes/load22.gif' id = 'loaderGif_4' style = 'display:none;width:30px;'/> </center></button>
