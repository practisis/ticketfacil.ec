					...
					<thead>
						...
						<tr>
							...
							<?php
								...
								$resD = mysql_query($sqlD) or die (mysql_error());
								while($rowD = mysql_fetch_array($resD)){
									$sqlB = 'select count(idBoleto) as cuantos , sum(valor) as valor_desc from Boleto where idCon = "'.$idCon.'" and idLocB = "'.$row['idLocalidad'].'" and tercera = 1 and id_desc = "'.$rowD['id'].'" ';
							...
							<?php
								...
								$sqlB1 = 'select count(idBoleto) as cuantos2 , sum(valor) as valor_normal from Boleto where idCon = "'.$idCon.'" and idLocB = "'.$row['idLocalidad'].'" and tercera = 0 and id_desc = "0" ';
