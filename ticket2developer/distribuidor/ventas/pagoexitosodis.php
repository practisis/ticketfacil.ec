...
<div style="margin:0px -10px">
	<div style="background-color:#171A1B; padding:20px;">
		<div style="border: 2px solid #00AEEF; margin:20px;">
			...
			<div style="<?php echo $disp;?>background-color:#00ADEF; margin: 20px -42px 30px 40px; position:relative; padding:40px 40px 40px 0px;">
			...
			<div style="<?php echo $dispError;?>background-color:#00ADEF; margin: 20px -42px 30px 40px; position:relative; padding:40px 40px 40px 0px;">
				<table style="width:100%; margin:20px; color:#fff; font-size:25px; border-collapse:separate; border-spacing:0px 20x;">
					<tr align="center">
						<td>
					...
					<tr align="center">
						<td>
							<p>Error , uno a mas de sus tickets ya han sido seleccionados , debera volver a comprar</p>
						</td>
					</tr>
