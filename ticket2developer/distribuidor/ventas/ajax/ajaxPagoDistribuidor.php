<?php 
	...
	foreach(explode('@', $_REQUEST['valores']) as $value){
		$mm++;
			...
			$insert2 = 'INSERT INTO Boleto VALUES ("NULL","'.$seccion.'","'.$code.'",'.$idcliente.','.$idconcierto.','.$exp[0].',"'.$valorPago.'","'.$quien_vendio_boleto.'","'.$tercera.'", "'.$espreventa.'" , "2" , "" ,  '.$exp[7].',"A","S","'.$numeroSerie.'" ,"'.$numeroSerie_localidad.'","'.$sitiene.'" , "'.$_SESSION['iduser'].'" , "0" , "0")';
			echo $insert2."<< aqui >>".$mm"<br>";
			// exit;
