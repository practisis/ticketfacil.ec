			...
			if($tiene_permisos != 0){
						...
						<table height="auto" border="0" style="border:2px dashed #ccc;" id="contieneElBoletoImprime">
							<tr>
								<td valign="middle" align="left" style="border-bottom:2px dashed #ccc;">
									<img src="http://ticketfacil.ec/ticket2/distribuidor/cobros/ajax/barcode/'.$rowImp['strBarcode'].'.png" width="200px" style="text-align:center;height:40px;-ms-transform: rotate(0deg);-webkit-transform: rotate(0deg);transform: rotate(180deg);"/><br/>
									<center>
							...
							<tr>
								<td valign="middle" align="left">
									<table width="100%" height="100%" border="0">
										<tr>
											<td align="center">
												<img src="barcode/'.$rowImp['strBarcode'].'.png" width="200px" style="text-align:center;height:40px;-ms-transform: rotate(0deg);-webkit-transform: rotate(0deg);transform: rotate(180deg);"/><br/>
												<span style="text-align:center;height:40px;-ms-transform: rotate(0deg);-webkit-transform: rotate(0deg);transform: rotate(180deg);font-size:10px;">'.$rowImp['strBarcode'].'</span>
											</td>
										</tr>
										<tr>
				...
				$autorizaciones2 = '
					<div style="font-size:6px;background-color:#fff;padding:5px;margin-right: -20px" id="parteDiminuta">
						...
						'.$strEvento.' que se llevará a cabo el dia : '.$dia.' - '.$fechaMostrar.' '.$timeHora.' <br/>
						Le recordamos que ud debe canjear su boleto real en este punto de servicio <br/>hasta el dia: '.$rowBol['fechafinalcanjeC'].'
				...
				$print='
					<div >
						<table height="auto" border="0" style="border:2px dashed #ccc;" id="contieneElBoletoImprime">
							<tr>
								<td valign="middle" align="center" style="border-bottom:2px dashed #ccc;">
									<div style="text-align:center;padding-left:10px;text-align:left;height:;-ms-transform: rotate(0deg);-webkit-transform: rotate(0deg);transform: rotate(180deg);" >
										<img src="barcode/'.$rowImp['strBarcode'].'.png" width="200px" style="text-align:center;height:40px;-ms-transform: rotate(0deg);-webkit-transform: rotate(0deg);transform: rotate(180deg);"/><br/>
										<center><span style="text-align:center;height:40px;-ms-transform: rotate(0deg);-webkit-transform: rotate(0deg);transform: rotate(180deg);font-size:10px;">'.$rowImp['strBarcode'].'</span></center>
									</div>
									<div style="padding-bottom:10px;text-align:center;height:;-ms-transform: rotate(0deg);-webkit-transform: rotate(0deg);transform: rotate(180deg);" >
										...
										<span align="left" style="font-family:roboto,sans-serif;text-align:left;font-size:9px;"><strong>'.$rowDetBol['localidad'].'</strong> <strong>'.$rowDetBol['asientos'].'</strong></span><br/>
										<span align="left" style="font-family:roboto,sans-serif;text-align:left;font-size:12px;font-weight:bolder;">Valor US $: <strong>'.$rowDetBol['precio'].'</strong></span>
									</div>
								</td>
							</tr>
							<tr>
