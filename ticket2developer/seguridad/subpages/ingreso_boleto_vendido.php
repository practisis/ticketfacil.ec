				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="alert alert-success" role="alert">
							...
							<strong>Alerta! </strong>Ticket registrado con éxito, Gracias por usar nuestros servicios
						</div>
					</div>
					<div class="modal-footer">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="alert alert-danger" role="alert">
							...
							<strong>Alerta! </strong>Este ticket ya esta registrado , Gracias por usar nuestros servicios
						</div>
					</div>
					<div class="modal-footer">
