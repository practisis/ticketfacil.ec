...
<html>
	...
	<body style = 'width:100%;height:100%;background-color:#D5D5D5;'>
		<button type="button" class="btn btn-primary" style = 'float:right;' onclick = 'window.location="salir_viernes.php"'>Salir</button>
		<button type="button" class="btn btn-warning" style = 'float:right;' onclick="window.open('http://ticketfacil.ec/ticket2/seguridad/reporte_viernes.php','_blank');">Ver Reporte</button>
		<!--
		<div class="row">
			<div class="col-lg-3">
