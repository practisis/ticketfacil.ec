...
<script type="text/javascript">
	...
	var stripeResponseHandler = function(status, response) {
		...
		if(response.error){
			...
			$.post('subpages/ajaxChargeCard.php',{
			...
			<div style="margin:40px; border:2px solid #000; color:#000; font-size:20px;">
				...
				<div class="row">
					...
					<?php
						...
						$sqlC = 'select * from Usuario where idUsuario = "'.base64_decode($_SESSION['sesion_usuario']).'" ';
						//echo $sqlC;
				...
				<div class="row">
					...
					<div class="col-lg-6 titleright" style="margin:0px; padding:10px;">
						<p><?php echo $_SESSION['total_venta'];?></p>
						<input type = 'text' id = 'total' value = '<?php echo $_SESSION['total_venta'];?>' />
					</div>
				</div>
			</div>
