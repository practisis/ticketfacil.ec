<?php
	...
	$accion = 'Ingreso al Log Tributario';
	$estado = 'Activo';
			...
			<div id="validado" style="display:none;">
				<div style="background-color:#00ADEF; margin:20px -42px -10px 40px; position:relative; padding:20px 0 10px; text-align:center; color:#fff; font-size:18px;">
					...
					<p class="byUser" style="display:none;">
						<strong>Nombre:</strong>&nbsp;&nbsp;<input type="text" id="nameUser" class="inputlogin" onkeypress="return validarLetras(event)" placeholder="Usuario" />&nbsp;&nbsp;
					...
					<p class="byCli" style="display:none;">
						<strong>Nombre:</strong>&nbsp;&nbsp;<input type="text" id="nameCli" class="inputlogin" onkeypress="return validarLetras(event)" placeholder="Cliente" />&nbsp;&nbsp;
					...
					<p class="byEmp" style="display:none;">
						<input type="text" id="nameEmp" class="inputopcional" readonly="readonly" placeholder="Empresa" />&nbsp;&nbsp;
						...
						<button type="button" class="btnlink" id="cancel4" onclick="cancel()">Cancelar&nbsp;<img src="imagenes/clouse.png"/></button>
					</p>
					<div class="tra_azul"></div>
					<div class="par_azul"></div>
				</div>
...
$(document).ready(function(){
	...
	$('.paginate').live('click', function(){
		...
		$.ajax({
			...
			data: {page : page, desde : desde, hasta : hasta, id : id, nombreUser : nombreUser, nombreCli : nombreCli, Emp : Emp, log : log},
