<?php
	...
	$accion = 'Ingreso al Log de Acceso y Control';
	$estado = 'Activo';
...
$(document).ready(function(){
	...
	$('.paginate').live('click', function(){
		...
		$.ajax({
			...
			data: {page : page, desde : desde, hasta : hasta, id : id, nombreUser : nombreUser, log : log},
...
function print(id){
	...
	if(id == 1){
		...
		if(id == 2){
			...
			$.post('Adt/reportes.php',{
				nameUser : nameUser, id : id, log : log
			}).done(function(data){
				window.open('Adt/pdf/'+data+'.pdf','nuevo','scrollbars=yes');
			});
		}
