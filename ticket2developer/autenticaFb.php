<?php
	...
	if(mysql_num_rows($resC) == 0 || mysql_num_rows($resC) == ''){
		//echo 'no hay';
		$sqlC1 = 'insert into Cliente (strNombresC , strMailC , strContrasenaC , strDocumentoC , strFechaNanC , strGeneroC , clave_face) values ("'.$name.'" , "'.$email_face.'" , "e10adc3949ba59abbe56e057f20f883e" , "" , "'.$fnac.'" , "'.$sexo.'" , "'.$id_face.'" ) ';
		//echo $sqlC1;
