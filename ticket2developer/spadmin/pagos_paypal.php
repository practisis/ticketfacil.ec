<?php
		...
		echo '<input type="hidden" id="data" value="37" />';
?>		
		<style>
			.carpeta:hover{
				cursor:pointer;
		...
		<div style="border: 2px solid #00AEEF; margin:20px;">
			<div style="background-color:#EC1867; color:#fff; margin:20px 50px 0px 0px; padding:5px 0px 5px 40px; font-size:20px;">
				<strong>REPORTES PAGOS PAYPAL</strong>
			</div><br>
			...
			<i onclick="tableToExcel3('recibeTransferencias', 'REPORTE PAGOS POR PAYPAL ')" class="fa fa-file-excel-o fa-2x" style = 'float:right;color:#fff;cursor:pointer;' title = 'descarga a excel el reporte de compras por transferencia bancaria!!!' ></i>
			<br>
			<br>
