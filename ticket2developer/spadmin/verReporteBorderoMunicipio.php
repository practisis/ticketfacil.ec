<?php
	...
	// echo 'holaaaaaaaaaaaaaaaaaaaaaaaaa';
...
?>
	...
	<table  id = "desglose_sri" class = 'table table-bordered'>
		<tr>
			...
			?>
					<tr class = 'valores_macros' style = 'font-size:12px !important;'>
			...
			<td style = 'vertical-align:top;'>
				<table class = 'table table-bordered' id = "desglose_sri">
					<tr>
						<th colspan = '9' >
							CORTESIAS
						</th>
			...
			?>
					<tr class = 'valores_macros' style = "heigth: 35px" >
						<th style = 'text-align:left;' >
							<?php echo $row['macro_localidad'];?>
							<input style="display:none;" class="" value="" type="hidden">
						</th>
						<td >
			...
			?>
						...
						<tr style = 'font-size:12px !important; heigth: 35px'>
							<td>
								<?php echo $rowD1['nom'];?>
							</td>
			...
			?>
					...
					<tr class = 'suma_total_aut_menos_vendidos_ooooo' numero_localidad = "<?php echo $row['idLocalidad']?>" style = 'display:none;'>
