		...
		<div style="margin:10px -10px;">
			...
			<div style="background-color:#171A1B; padding-right:3%;padding-left: 2%">
				<div class = 'row'>
					<div class = 'col-md-12'>
						<h3 style = 'padding-top: 10px;padding-bottom: 10px;padding-left: 10px;padding-right: 10px;background-color: #ED1568;color: #000'>
							RESUMEN DE VENTAS DISTRIBUIDOR
						</h3>
					</div>
				</div>
				...
				<div class = 'row'>
					...
					<div class = 'col-md-3'>
						<br>
						<button type="button" class="btn btn-default" id = 'ejecuta' >Ejecutar</button>
					</div>
				</div>
	...
	<script>
		$( document ).ready(function() {
			$("#ejecuta").click(function(e){
				$('#recibeConsulta').html('<center><h1 style = "color:#fff;" >ESPERE CARGANDO INFORMACIÓN</h1></center>');
				...
				if(evento_distri == ''){
					...
					$.post("spadmin/muestraResumen.php",{ 
