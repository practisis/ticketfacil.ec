						...
						<div class="col-lg-12" style="margin:0px;padding:10px;">
							<center>
								<div id="recibeBoletoAImprimir">
									<img src="http://ticketfacil.ec/imagenes/loading.gif" id="loadBoleto">
								</div>
							</center>
						</div>
					</div>
...
<script>
	...
	$( document ).ready(function() {
		var id = $('#iduser').val();
		$.post('spadmin/buscarConciertoClonar_2.php',{
			id : id
		}).done(function(json){
			...
			for(i=0; i <= (obj.Concierto.length -1); i++){
				...
				$('#select_conciertos').append('\
										<tr class="filas_con" style="text-align:center">\
											<td style = "border:1px solid #fff;text-align:center;"><img src="spadmin/'+imagen+'" id="img_con"/></td>\
											...
											<td style = "border:1px solid  #fff;text-align:center;">\
												...
												<button type="button" class="btn btn-success" onclick = "clonarEvento('+id+')" style = "text-align:center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Clonar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;['+id+']</button><br/><br/>\
