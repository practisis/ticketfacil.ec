...
echo "TLS test (TLS_v1): " . get_tls_version(2) . "\n";
echo "TLS test (TLS_v1): " . get_tls_version(3) . "\n";
echo "TLS test (TLS_v1): " . get_tls_version(4) . "\n";
echo "TLS test (TLS_v1): " . get_tls_version(5) . "\n";
