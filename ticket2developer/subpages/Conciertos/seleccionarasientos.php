<?php 
	...
	echo '<td style="text-align:center; border:none;"><center><font color="#000"><button type="button" class="btn_eliminar btn btn-danger btn-xs" id="delete'.$id_localidad.'" onclick="elimanarsillas('.$id_localidad.','.$id_concierto.','.$rows.','.$col.')">Eliminar</button></font></center></td>
	</tr>';
?>