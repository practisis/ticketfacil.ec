...
$consult = 'SELECT idBoleto, serie_localidad, strEstado as estado from Boleto where idCon = "'.$evento_reimprime.'0000" and idLocB = "'.$local.'" AND `serie_localidad` >= "'.$desdeact.'" AND serie_localidad <= "'.$hastaact.'"';
...
if ($a == '') {
    ...
    echo "<div id=''> Estos boletos se encuentran reimpresos: ".$a."<span id='num-boletos' style='color:transparent'>".$c."</span></div>";
    echo "<div id='' style=''>Estos no: ".$b."<span id='no-reimpresos' style='color:transparent'>".$d."</span></div>";
}
