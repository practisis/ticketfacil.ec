			...
			<page>
				<table align="center" style="width:100%; border-collapse:separate; border-spacing:15px 5px;">
					...
					<tr>
						<td style="text-align:center;">
							<br>
							* Puede acercarse a cualquier: <strong>SERVIPAGOS</strong> para cancelar el valor adeudado, realizar <strong>TRANSFERENCIA BANCARIA o DEPOSITO EN EFECTIVO</strong> en la cuenta #<strong>0000000000</strong>.
						</td>
					</tr>
					<tr>
						<td>
							<br>
							Despues de realizar el depósito ingrese al siguiente link:http://104.131.65.202/ticket/admin/despositoreserva.php?cod='.$random.', para validar tu pago.
						</td>
					</tr>
					<tr>
						<td style="text-align:center;">
