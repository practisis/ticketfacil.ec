...
<div class="divborderexterno" style = 'margin:0 !important;'>
	<div style="padding-top:20px;padding-bottom:20px; background-color:#0083C2; margin-right:50%; margin-top:20px; padding-left:30px; font-size:25px; color:#fff;">
	...
	<div style="background-color:#282B2D; margin-left:0px; margin-top:50px; position:relative;">
		<div class="row">
			...
			?>
				<div class="col-md-4 col-md-5 col-xs-6 col-xs-8 col-xs-12 nopromos" style = 'height: 420px;background-color: #eee'>
					<div id="producto" class="panel panel-default" style="margin:10px; font-family:Roboto; font-size:13px;font-family:helvetica;">
						<div class="panel-heading" style = 'text-align: center'> 
							<a href="?modulo=<?php echo $linkConcPub;?>&con=<?php echo $rowConcierto['idConcierto'];?>" style = 'text-decoration:none;' >
								<center>
									<img src="<?php echo $rutaCon;?>" alt="<?php echo $rowConcierto['strEvento'];?>" class = 'img-responsive' />
								</center>
							</a>
						</div>
							...
							<table width = '100%' height = '100%'>
								<tr>
									<td style = 'vertical-align:middle;align:;left'>
										...
										<label style = 'font-size:10px;color:#282B2D;'><i class="fa fa-calendar fa-lg" aria-hidden="true" style = 'color:#0083C2;'></i> : <?php echo $rowConcierto['dateFecha'];?></label>  /  
										<label style = 'font-size:10px;color:#282B2D;'><i class="fa fa-clock-o fa-lg" aria-hidden="true" style = 'color:#0083C2;'></i> : <?php echo $rowConcierto['timeHora'];?></label><br> 
										<label style = 'font-size:10px;color:#282B2D;text-transform:uppercase;'><i class="fa fa-building-o fa-lg" aria-hidden="true" style = 'color:#0083C2;'></i> : <?php echo $rowConcierto['strLugar'];?></label>
									</td>
								</tr>
							</table>
						</div>
