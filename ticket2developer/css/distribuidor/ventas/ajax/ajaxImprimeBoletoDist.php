	...
	if($tiene_permisos != 0){
				...
				<table height="auto" border="0" style="border:2px dashed #ccc;" id="contieneElBoletoImprime">
					<tr>
						<td valign="middle" align="left" style="border-bottom:2px dashed #ccc;">
							<img src="http://ticketfacil.ec/ticket2/distribuidor/ventas/ajax/barcode/'.$rowImp['strBarcode'].'.png" width="200px" style="text-align:center;height:40px;-ms-transform: rotate(0deg);-webkit-transform: rotate(0deg);transform: rotate(180deg);"/><br/>
							<center>
		...
		$autorizaciones ='
			...
			<div style="font-size:6px;" id="parteDiminuta">
				...
				Le recordamos que ud debe canjear su boleto real en '.$rowBol['dircanjeC'].' <br/>
				desde el dia '.$rowBol['fechainiciocanjeC'].' hasta el dia '.$rowBol['fechafinalcanjeC'].' <br/>
				en el horario de '.$rowBol['horariocanjeC'].' gracia por cinfiar en nosotros<br/>
		...
		$autorizaciones2 = '
			<div style="font-size:6px;background-color:#fff;padding:5px;margin-right: -20px" id="parteDiminuta">
				...
				Le recordamos que ud debe canjear su boleto real en '.$rowBol['dircanjeC'].' <br/>
				desde el dia '.$rowBol['fechainiciocanjeC'].' hasta el dia '.$rowBol['fechafinalcanjeC'].' <br/>
				en el horario de '.$rowBol['horariocanjeC'].' gracia por cinfiar en nosotros
				ticketfacil.ec
			</div>
		';
