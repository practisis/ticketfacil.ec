				...
				<table height="auto" border="0" style="border:2px dashed #ccc;" id="contieneElBoletoImprime">
					<tr>
						<td valign="middle" align="left" style="border-bottom:2px dashed #ccc;">
							<img src="http://ticketfacil.ec/pagekiosko/subpages/Compras/barcode/'.$rowImp['strBarcode'].'.png" width="200px" style="text-align:center;height:40px;-ms-transform: rotate(0deg);-webkit-transform: rotate(0deg);transform: rotate(180deg);"/><br/>
							<center>
