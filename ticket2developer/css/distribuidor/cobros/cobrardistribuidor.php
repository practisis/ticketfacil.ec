	...
	<div style="background-color:#171A1B; padding:20px;">
		<div style="border: 2px solid #00AEEF; margin:20px;">
			...
			<div class="row" style="padding:30px 0px; text-align:center;">
				<div class="col-lg-12">
					<button type="button" class="btndegradate" onclick="confirmar()">REGISTRAR PAGO</button>&nbsp;&nbsp;
...
function registarPago(codigo){
	...
	$.post('distribuidor/cobros/ajax/ajaxRegistrarCobros.php',{
		codigo : codigo, identificador : identificador, total : total, formapago : formapago
